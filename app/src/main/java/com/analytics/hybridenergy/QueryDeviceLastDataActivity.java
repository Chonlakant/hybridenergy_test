...
public class QueryDeviceLastDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sing = SHA1(salt + Secret + Token + "&action=queryDeviceLastData&source=1&app_id=com.softtechnetwork.PSI-Hybrid-Energy&app_version=1&app_client=web&pn="+pn+"&devcode="+devcode+"&devaddr="+devaddr+"&sn="+sn+"&date="+"2022-09-21");
